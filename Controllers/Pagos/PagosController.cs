            ...
            try
            {
                var sql = @"
                    SELECT
                        ...
                        CONVERT(VARCHAR(10), sp.fecha_solicitud,    103)            AS fecha_solicitud,
                        CONVERT(VARCHAR(10), sp.fecha_autorizacion, 103)            AS fecha_autorizacion,
                        CONVERT(VARCHAR(10), sp.fecha_pago,         103)            AS fecha_pago,
                        sp.folio_pago,
                        sp.banco_id,
                        bc.nombre_banco,
                        sp.metodo_pago,
                        ...
                        CONVERT(VARCHAR(10), fr.fecha_recepcion,    103)            AS fecha_entrega,
                        fr.rfc_productor,
